...
public class MainActivity extends ActionBarActivity {
    ...
    private class HttpRequestTask extends AsyncTask<Void, Void, Clientlist> {
        ...
        protected void onPostExecute(Clientlist clientlist) {
            TextView clientlistIdText = (TextView) findViewById(R.id.id_value);
            TextView clientlistContentText = (TextView) findViewById(R.id.fullname_value);
            clientlistIdText.setText(clientlist.get_id());
            clientlistContentText.setText(clientlist.getFullname());
        }
